...
import { ExperienceItem } from "../_data/profileSeed";

export default function ExperienceCard({ items }: { items: ExperienceItem[] }) {
  return (
          ...
          <div key={exp.id}>
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-900">{exp.company}{exp.employmentType ? ` • ${exp.employmentType}` : ''}</div>
                ...
                {exp.description && (
                  <p className="text-sm text-gray-900 mt-2 leading-relaxed">{exp.description}</p>
                )}
              </div>
            </div>
